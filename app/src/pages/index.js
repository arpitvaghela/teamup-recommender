...
const menu_options = [
  { name: "Dashboard", icon: homesvg },
  { name: "Inbox", icon: inboxsvg },
  { name: "MyTeam", icon: myteamsvg },
  { name: "All Team", icon: teamsvg },
  { name: "Edit Profile", icon: profilesvg },
];
const dashboard = 0;
const myteam = 2;
const allteam = 3;
...
const Drawer = ({ selected, setSelectedPage }) => {
  return (
    <div className="bg-indigo-700 justify-center w-1/6">
      <h1 className="text-purple-100 font-sans text-3xl text-center pt-10">
        TeamUp
      </h1>
        ...
        {menu_options.map((e, i) => {
          return (
            <div
              ...
              className={
                "text-blue-300 capitalize text-lg px-4 py-2 w-full rounded-md text-center cursor-pointer flex  " +
